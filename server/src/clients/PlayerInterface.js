...
class PlayerInterface {
    ...
    get isDown() { return this.player.isDown; }
    set isDown(value) { this.player.isDown = value; }
    get tookCard() { return this.player.tookCard; }
    set tookCard(value) { this.player.tookCard = value; }
    get discarded() { return this.player.discarded; }
    set discarded(value) { this.player.discarded = value; }
    get isOut() { return this.player.isOut; }
    set isOut(value) { this.player.isOut = value; }

    roundReset() { return this.player.roundReset(); }
    downPlaysForOneRound(gameState) { return this.player.downPlaysForOneRound(gameState); }
    toString() { return this.player.toString(); }
