...
describe('Reshuffle Notification Tests', () => {
  ...
  test('should display reshuffle notification when DECK_RESHUFFLED event is processed', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('🔄 Deck was reshuffled! 5 cards were moved from discard pile to deck.');
  });
  ...
  test('should display reshuffle notification with singular card when only 1 card reshuffled', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('🔄 Deck was reshuffled! 1 cards were moved from discard pile to deck.');
  });
  ...
  test('should display reshuffle notification with larger numbers', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('🔄 Deck was reshuffled! 25 cards were moved from discard pile to deck.');
  });
  ...
  test('should not interfere with other event processing', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('🔄 Deck was reshuffled! 3 cards were moved from discard pile to deck.');
  });
});