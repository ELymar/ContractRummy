...
async function testResume() {
    ...
    console.log(`Dealer should be: ${game1.dealerIndex === 1 ? 'Bob' : 'Alice'} (index: ${game1.dealerIndex})`);
    ...
    console.log(`Dealer should be: ${game2.dealerIndex === 1 ? 'Diana' : 'Charlie'} (index: ${game2.dealerIndex})`);
    ...
    const previousScores3 = [
        [20, 25], [15, 30], [35, 10], [40, 25], [15, 20], [30, 15] // 6 rounds completed
    ];
    
    const game3 = new TerminalGame('Eve', 'Frank', previousScores3);
    console.log(`Current round should be: 7 (actual: ${game3.currentRound})`);
    console.log(`Dealer should be: ${game3.dealerIndex === 0 ? 'Eve' : 'Frank'} (index: ${game3.dealerIndex})`);
    ...
    console.log('const game = new TerminalGame("Player1", "Player2", [[p1_r1, p2_r1], [p1_r2, p2_r2], ...]);');
}
