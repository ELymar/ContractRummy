...
@onready var hand_meld_test_button = $CenterContainer/VBoxContainer/ButtonContainer/HandMeldTestButton
...
func _ready():
	...
	hand_meld_test_button.pressed.connect(_on_hand_meld_test_pressed)
...
func _on_hand_meld_test_pressed():
	print("Hand Meld Test clicked")
	SceneManager.change_scene("HandMeldTest")
